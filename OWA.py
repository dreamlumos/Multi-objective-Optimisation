...
def OWA_LP(n, p, utilities, weights):
	...
	try:
		...
		y = m.addMVar(shape=n, vtype=GRB.INTEGER, name="y") # TODO: Check if possible and if faster if we use continuous variables here
